<div class="wrapper text-left">
  <div class="row">
        <content class="col-sm-3 col-sm-push-9">
            <div class="aside-user-buttons">
                <div class="list-group">
                    ...
                    <a href="{$BASE_DIR}pages/user/my-page-my-events.php" class="list-group-item">My Events</a>
                    <a href="{$BASE_DIR}pages/user/my-page-invitations.php" class="list-group-item">Invitations</a>
                    <a href="{$BASE_DIR}pages/user/my-page-notifications.php" class="list-group-item">Notifications</a>
